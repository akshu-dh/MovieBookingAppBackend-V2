...
//				new Movie("test1", "test", "test", 100, "test", new HashSet<>(), new ArrayList<>())); for mongo
		List<Movie> movies = Arrays.asList(
				new Movie(101l, "test", "test", 100, "test",  new ArrayList<>()),
				new Movie(102l, "test", "test", 100, "test",  new ArrayList<>()));
